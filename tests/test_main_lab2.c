...
// Diagnostic fault handlers to identify which exception occurs
volatile unsigned int fault_type = 0;
volatile unsigned int fault_address = 0;
volatile unsigned int fault_cfsr = 0;
volatile unsigned int fault_hfsr = 0;
volatile unsigned int fault_lr = 0;
volatile unsigned int fault_pc = 0;
